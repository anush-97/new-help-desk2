...
<head>
  ...
  <link rel="icon" href="gamma interpharm logo.jpg" type="gamma interpharm logo.jpg">
  <style>
    body {
      ...
      background-image: url("gammainterpharm brandin main logo x2.jpg"); /* The image used */
      background-color: #FFFFFF; /* Used if the image is unavailable */
      height: 40%; /* You must set a specified height */
