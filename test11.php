...
<body>
  <div class="container">
    ...
    <button id="clearAllFiltersBtn" class="button button-secondary">Clear All Filters</button>
  </div>
  ...
  <script>
    class TicketManager {
      constructor() {
        this.tickets = <?php echo json_encode($tickets); ?>;
      ...
      createTicket() {
        ...
        <?php $tickets[] = "<script>document.write(JSON.stringify(ticket))</script>"; ?>
